...
See also scil_tractogram_project_streamlines_to_map for the reverse action.
...
reflect poorly your map. You may use scil_tractogram_resample to upsample
...
>> scil_tractogram_project_map_to_streamlines $in_bundle $in_bundle
       --keep_all_dpp -f
"""
