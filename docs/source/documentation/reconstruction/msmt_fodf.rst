...
::
    ...
    csf_frf.txt --mask brainmask.nii.gz --mask_wm wm_mask.nii.gz \
    --mask_gm gm_mask.nii.gz --mask_csf csf_mask.nii.gz -f
...
::
    ...
    scil_fodf_msmt dwi.nii.gz dwi.bval dwi.bvec wm_frf.txt gm_frf.txt \
    csf_frf.txt --mask brainmask.nii.gz -f
