...
def main():
    ...
    hurdle = DataVolume(hurdle_data, hurdle_res, args.mask_interp)

#####################################################################################
    #functions that take has input the tracking data and the current streamline
    #and return a new streamline.
    if args.hurdle_method == "continue":
        hurdle_fct = None # functer
    elif args.hurdle_method == "graph":
        hurdle_fct = None # functer
    elif args.hurdle_method == "quacto":
        hurdle_fct = None # functer
#####################################################################################
    ...
    #####################################################################################
    tracker = HurdleTracker(propagator, mask, hurdle, hurdle_fct, seed_generator,
                      nbr_seeds, min_nbr_pts,
