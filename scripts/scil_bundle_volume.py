...
"""
Compute bundle volume in mm³. This script support anisotropic voxel resolution.
Volume is estimated by counting the number of voxel occupied by the bundle and
